...
function MyDownloads() {
  return (
    <View style={styles.download} showsVerticalScrollIndicator={false}>
      <View>
        <Image
          source={require('../../assets/NotFound.png')}
          style={styles.image}
        />
        <Text style={styles.comments}>No Catalogue Found</Text>
      </View>
    </View>
  );
}
  ...
  return (
    <ScrollView style={styles.mainContent}>
      ...
      <ScrollView
        ...
        <CatalogCard
          Data={TilesCatalogue}
          category="Featured Company Catalogue"
          showSponsored={true}
        />
        <CatalogCard
          Data={TilesCatalogue}
...
function Sanitaryware() {
  return (
    <ScrollView style={styles.mainContent}>
      <View>
        <Text>Sanitaryware Screen Content</Text>
      </View>
    </ScrollView>
  );
}
...
function Bathware() {
  return (
    <ScrollView style={styles.mainContent}>
      <View>
        <Text>Bathware Screen Content</Text>
      </View>
    </ScrollView>
  );
}
...
function Adhesive() {
  return (
    <ScrollView style={styles.mainContent}>
      <View>
        <Text>Adhesive Screen Content</Text>
      </View>
    </ScrollView>
  );
}
